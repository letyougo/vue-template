<template>
  <div class="user">
    ...
    <el-form :inline="true" class="demo-form-inline" :loading="loading">
      ...
      <el-form-item>
        <el-button  @click="add_form.visible=true">增加商品</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-dialog title="增加商品" :visible.sync="add_form.visible"
    >
      <el-form class="demo-form-inline" label-width="100px">
        ...
        <el-form-item label="标题">
          <el-input v-model="add_form.title" placeholder="输入标题"></el-input>
        </el-form-item>
    ...
    <el-dialog title="编辑商品" :visible.sync="edit_form.visible"
    >
      <el-form class="demo-form-inline"  label-width="100px">
        ...
        <el-form-item label="标题">
          <el-input v-model="edit_form.title" placeholder="输入姓名查询"></el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods:{
      ...
      async add(){
        ...
        var response = await request.post('/data/ryan/good/',add_form)
        this.fetch()
      },
      async remove(data){
        var response = await request.delete('/data/ryan/good/'+data.id)
        this.fetch()
      },
      async edit(){
        ...
        var response = await request.patch('/data/ryan/good/'+id,edit_form)
        this.fetch()
      }
    },
    mounted(){
